...
public class PlateStickyPiston extends Plate<PlateStickyPiston.Data> {
    ...
    public static class Item extends AbstractPlateItem<Data, PlateStickyPiston> {
        ...
        @Override
        public PlateStickyPiston getPlate() {
            return PlateStickyPiston.instance();
        }
    }
    public static final PlateRenderer renderer = new TexturePlateRenderer() {
        public static final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(MicroProcessorMod.MODID, "block/microprocessor_sticky_piston");
        @Override
    ...
    public static class Jso extends AbstractJsoPlate {
        ...
        public Jso(MicroProcessorWorker worker, Direction direction, PlateState<?, ?> plateState) {
            super(worker, PlateStickyPiston.instance(), direction, plateState);
            this.update(plateState);
        }
        public void update(PlateState<?, ?> plateState1) {
            PlateState<Data, PlateStickyPiston> plateState = (PlateState<Data, PlateStickyPiston>) plateState1;
